using System;
using Tyuiu.SimonovMA.Sprint0.Task7.V0.Lib;

namespace Tyuiu.SimonovMA.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Ошибка! Исходные массивы имеют разные значения элементов");
            }
            Console.ReadKey();
        }
    }
